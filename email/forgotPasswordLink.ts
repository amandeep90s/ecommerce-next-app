export const forgotPasswordLink = (link: string) => {
  const html = `
<!DOCTYPE html>
                                                            ...
                                                            <td class="pad">
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0; word-break: break-word;">We
                                                                        received a request to reset the password for your account. Use
                                                                        the following link to
                                                                        complete the password reset process. This link is valid for 1 hour.</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <h4
                                                                    ...
                                                                    <a href="${link}"
                                                                        style="background-color: #7747FF;color:white;padding:10px 30px;text-decoration: none; border-radius: 50px;">Reset Password</a>
                                                                </h4>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad" style="padding-bottom:20px;padding-left:10px;padding-right:10px;padding-top:20px;">
                                                                <div
                                                                    style="color:#393d47;direction:ltr;font-family:Tahoma,Verdana,Segoe,sans-serif;font-size:12px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:14.399999999999999px;">
                                                                    <p style="margin: 0; word-break: break-word;">If you didn't request a password reset, you can safely ignore this email — your password will not be changed.</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
