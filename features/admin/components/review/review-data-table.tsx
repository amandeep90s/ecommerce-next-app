...
import type { IReviewPaginationMeta } from '@/types';

interface ReviewDataTableProps<TData> {
  columns: ColumnDef<TData>[];
  data: TData[];
  meta: IReviewPaginationMeta | undefined;
  isLoading: boolean;
...
export function ReviewDataTable<TData>({
  columns,
  data,
  meta,
  isLoading,
            ...
            {isLoading ? (
              ...
              <TableRow>
                <TableCell colSpan={columns.length} className="h-24 text-center">
                  <span className="text-muted-foreground text-sm">No reviews found.</span>
                </TableCell>
              </TableRow>
            ) : (
