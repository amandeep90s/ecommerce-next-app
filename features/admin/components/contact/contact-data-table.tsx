...
import type { IContactPaginationMeta } from '@/types';

interface ContactDataTableProps<TData> {
  columns: ColumnDef<TData>[];
  data: TData[];
  meta: IContactPaginationMeta | undefined;
  isLoading: boolean;
...
export function ContactDataTable<TData>({
  columns,
  data,
  meta,
  isLoading,
