...
import type { IProductPaginationMeta } from '@/types';

interface ProductDataTableProps<TData> {
  columns: ColumnDef<TData>[];
  data: TData[];
  meta: IProductPaginationMeta | undefined;
  isLoading: boolean;
...
export function ProductDataTable<TData>({
  columns,
  data,
  meta,
  isLoading,
