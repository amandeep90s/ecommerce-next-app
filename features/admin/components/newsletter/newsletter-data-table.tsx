...
import type { INewsletterPaginationMeta } from '@/types';

interface NewsletterDataTableProps<TData> {
  columns: ColumnDef<TData>[];
  data: TData[];
  meta: INewsletterPaginationMeta | undefined;
  isLoading: boolean;
            ...
            {isLoading ? (
              ...
              <TableRow>
                <TableCell colSpan={columns.length} className="h-24 text-center">
                  <span className="text-muted-foreground text-sm">No subscribers found.</span>
                </TableCell>
              </TableRow>
            ) : (
