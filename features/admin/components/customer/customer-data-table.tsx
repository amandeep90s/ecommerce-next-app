...
import type { ICustomerPaginationMeta } from '@/types';

interface CustomerDataTableProps<TData> {
  columns: ColumnDef<TData>[];
  data: TData[];
  meta: ICustomerPaginationMeta | undefined;
  isLoading: boolean;
