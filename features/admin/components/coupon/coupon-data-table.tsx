...
import type { ICouponPaginationMeta } from '@/types';

interface CouponDataTableProps<TData> {
  columns: ColumnDef<TData>[];
  data: TData[];
  meta: ICouponPaginationMeta | undefined;
  isLoading: boolean;
...
export function CouponDataTable<TData>({
  columns,
  data,
  meta,
  isLoading,
            ...
            {isLoading ? (
              ...
              <TableRow>
                <TableCell colSpan={columns.length} className="h-24 text-center">
                  <span className="text-muted-foreground text-sm">No coupons found.</span>
                </TableCell>
              </TableRow>
            ) : (
