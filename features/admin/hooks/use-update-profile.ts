...
import type { IUpdateProfilePayload, IUpdateProfileResponse } from '@/types';

async function updateProfile(data: IUpdateProfilePayload): Promise<IUpdateProfileResponse> {
...
export function useUpdateProfile() {
  return useMutation({
    mutationFn: (data: IUpdateProfilePayload) => updateProfile(data),
  });
}
